...
//
// mcp_argo client JSON-RPC transport
//
// Command:
...
// Client lists the mcp_argo service endpoint HTTP clients.
type Client struct {
	// Doer is the HTTP client used to make requests to the mcp_argo service.
	Doer loomhttp.Doer
...
// NewClient instantiates HTTP clients for all the mcp_argo service servers.
...
// Initialize returns an endpoint that makes JSON-RPC requests to the mcp_argo
...
func (c *Client) Initialize() loom.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, loomhttp.ErrRequestError("mcp_argo", "initialize", err)
		}
...
func (c *Client) Ping() loom.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		resp, err := c.Doer.Do(req)
		if err != nil {
			return nil, loomhttp.ErrRequestError("mcp_argo", "ping", err)
		}
		return decodeResponse(resp)
	}
...
func (c *Client) ToolsList() loom.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		resp, err := c.Doer.Do(req)
		if err != nil {
			return nil, loomhttp.ErrRequestError("mcp_argo", "tools/list", err)
		}
		return decodeResponse(resp)
	}
...
func (c *Client) ToolsCall() loom.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		resp, err := c.Doer.Do(req)
		if err != nil {
			return nil, loomhttp.ErrRequestError("mcp_argo", "tools/call", err)
		}
...
func (c *Client) EventsStream() loom.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		resp, err := c.Doer.Do(req)
		if err != nil {
			return nil, loomhttp.ErrRequestError("mcp_argo", "events/stream", err)
		}
