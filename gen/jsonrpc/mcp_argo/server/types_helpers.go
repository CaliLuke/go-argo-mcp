...
//
// mcp_argo JSON-RPC server types helper types
//
// Command:
...
func NewInitializeResponseBody(res *mcpargo.InitializeResult) *InitializeResponseBody {
	body := &InitializeResponseBody{
		ProtocolVersion: res.ProtocolVersion,
	}
	if res.Capabilities != nil {
		body.Capabilities = marshalMcpargoServerCapabilitiesToServerCapabilitiesResponseBody(res.Capabilities)
	}
	if res.ServerInfo != nil {
		body.ServerInfo = marshalMcpargoServerInfoToServerInfoResponseBody(res.ServerInfo)
	}
	return body
}

// NewPingResponseBody builds the HTTP response body from the result of the
// "ping" endpoint of the "mcp_argo" service.
func NewPingResponseBody(res *mcpargo.PingResult) *PingResponseBody {
...
// the "tools/list" endpoint of the "mcp_argo" service.
func NewToolsListResponseBody(res *mcpargo.ToolsListResult) *ToolsListResponseBody {
	...
	if res.Tools != nil {
		...
		for i, val := range res.Tools {
			...
			body.Tools[i] = marshalMcpargoToolInfoToToolInfoResponseBody(val)
		}
	} else {
...
// the "tools/call" endpoint of the "mcp_argo" service.
func NewToolsCallResponseBody(res *mcpargo.ToolsCallResult) *ToolsCallResponseBody {
	...
	if res.Content != nil {
		...
		for i, val := range res.Content {
			...
			body.Content[i] = marshalMcpargoContentItemToContentItemResponseBody(val)
		}
	} else {
...
// the "events/stream" endpoint of the "mcp_argo" service.
func NewEventsStreamResponseBody(res *mcpargo.EventsStreamResult) *EventsStreamResponseBody {
...
// NewInitializePayload builds a mcp_argo service initialize endpoint payload.
func NewInitializePayload(body *InitializeRequestBody) *mcpargo.InitializePayload {
	v := &mcpargo.InitializePayload{
		ProtocolVersion: *body.ProtocolVersion,
	}
	v.ClientInfo = unmarshalClientInfoRequestBodyRequestBodyRequestBodyRequestBodyToMcpargoClientInfo(body.ClientInfo)

	return v
}

// NewToolsListPayload builds a mcp_argo service tools/list endpoint payload.
func NewToolsListPayload(body *ToolsListRequestBody) *mcpargo.ToolsListPayload {
	v := &mcpargo.ToolsListPayload{
		Cursor: body.Cursor,
	}
...
// NewToolsCallPayload builds a mcp_argo service tools/call endpoint payload.
func NewToolsCallPayload(body *ToolsCallRequestBody) *mcpargo.ToolsCallPayload {
	v := &mcpargo.ToolsCallPayload{
		Name:      *body.Name,
