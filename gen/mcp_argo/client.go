...
// Client is the "mcp_argo" service client.
type Client struct {
...
// NewClient initializes a "mcp_argo" service client given the endpoints.
...
// Initialize calls the "initialize" endpoint of the "mcp_argo" service.
...
// Ping calls the "ping" endpoint of the "mcp_argo" service.
...
// ToolsList calls the "tools/list" endpoint of the "mcp_argo" service.
...
// ToolsCall calls the "tools/call" endpoint of the "mcp_argo" service.
...
// ToolsCallStream calls the "tools/call" endpoint of the "mcp_argo" service
...
// EventsStream calls the "events/stream" endpoint of the "mcp_argo" service.
...
// EventsStreamStream calls the "events/stream" endpoint of the "mcp_argo"
