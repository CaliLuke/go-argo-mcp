...
func sdkToolBindings(adapter *MCPAdapter) ([]sdkbridge.ToolBinding, error) {
	...
	bindings = append(bindings, sdkbridge.ToolBinding{
		...
		Tool: &mcpsdk.Tool{
			...
			InputSchema:  sdkToolInputSchema("{\"type\":\"object\",\"properties\":{\"limit\":{\"type\":\"integer\",\"description\":\"Maximum number of workflows to return\",\"default\":50,\"minimum\":1,\"maximum\":9223372036854775807},\"namespace\":{\"type\":\"string\",\"description\":\"Kubernetes namespace to query; defaults to the server's ARGO_NAMESPACE\"},\"status\":{\"type\":\"string\",\"description\":\"Optional workflow status filter\",\"enum\":[\"Running\",\"Succeeded\",\"Failed\",\"Pending\",\"Error\"]}},\"additionalProperties\":false}"),
			Name:         "list_workflows",
	...
	bindings = append(bindings, sdkbridge.ToolBinding{
		...
		Tool: &mcpsdk.Tool{
			...
			InputSchema:  sdkToolInputSchema("{\"type\":\"object\",\"properties\":{\"namespace\":{\"type\":\"string\",\"description\":\"Kubernetes namespace; defaults to the server's ARGO_NAMESPACE\"},\"suspended\":{\"type\":\"boolean\",\"description\":\"Optional suspension-state filter\"}},\"additionalProperties\":false}"),
	...
	bindings = append(bindings, sdkbridge.ToolBinding{
		...
		Tool: &mcpsdk.Tool{
			...
			InputSchema:  sdkToolInputSchema("{\"type\":\"object\",\"required\":[\"name\"],\"properties\":{\"limit\":{\"type\":\"integer\",\"description\":\"Maximum history entries to return\",\"default\":10,\"minimum\":1,\"maximum\":9223372036854775807},\"name\":{\"type\":\"string\",\"description\":\"Exact CronWorkflow name; use list_cron_workflows to discover names\"},\"namespace\":{\"type\":\"string\",\"description\":\"Kubernetes namespace; defaults to the server's ARGO_NAMESPACE\"}},\"additionalProperties\":false}"),
	...
	bindings = append(bindings, sdkbridge.ToolBinding{
		...
		Tool: &mcpsdk.Tool{
			...
			InputSchema:  sdkToolInputSchema("{\"type\":\"object\",\"properties\":{\"label_selector\":{\"type\":\"string\",\"description\":\"Optional Kubernetes label selector\"},\"namespace\":{\"type\":\"string\",\"description\":\"Kubernetes namespace; defaults to the server's ARGO_NAMESPACE\"}},\"additionalProperties\":false}"),
	...
	bindings = append(bindings, sdkbridge.ToolBinding{
		...
		Tool: &mcpsdk.Tool{
			...
			InputSchema:  sdkToolInputSchema("{\"type\":\"object\",\"properties\":{\"label_selector\":{\"type\":\"string\",\"description\":\"Optional Kubernetes label selector\"}},\"additionalProperties\":false}"),
